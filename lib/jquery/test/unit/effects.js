...
test("animate unit-less properties (#4966)", 2, function() {
	stop();
	var div = jQuery( "<div style='z-validDataIndex: 0; position: absolute;'></div>" ).appendTo( "#qunit-fixture" );
	equal( div.css( "z-validDataIndex" ), "0", "z-validDataIndex is 0" );
	div.animate({ zIndex: 2 }, function() {
		equal( div.css( "z-validDataIndex" ), "2", "z-validDataIndex is 2" );
		start();
	});
});
